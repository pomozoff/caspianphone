...
#else
			[self lpConfigSetBool:YES forKey:@"debugenable_preference"];
#endif
		}
...
- (void)resetSettingsToDefault:(LinphoneCore *)lc {
    ...
    // Advanced
    lp_config_set_int(config, LINPHONERC_APPLICATION_KEY, "debugenable_preference", YES);         // Debug is OFF
...
#define APPMODE_SUFFIX @"prod"
        ...
        NSString *params = [NSString stringWithFormat:@"app-id=%@.%@;pn-type=iphone;pn-tok=%@;pn-call-snd=ring.caf;pn-msg-snd=msg.caf", [[NSBundle mainBundle] bundleIdentifier],APPMODE_SUFFIX,tokenString];
